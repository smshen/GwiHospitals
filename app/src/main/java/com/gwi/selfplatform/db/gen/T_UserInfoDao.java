...
public class T_UserInfoDao extends AbstractDao<T_UserInfo, Long> {
    ...
    /**
     * Properties of entity T_UserInfo.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property EhrId = new Property(12, String.class, "EhrId", false, "EHR_ID");
    };


    public T_UserInfoDao(DaoConfig config) {
        super(config);
    }
    
    public T_UserInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'T__USER_INFO' (" + //
                "'USER_ID' INTEGER PRIMARY KEY UNIQUE ," + // 0: UserId
                ...
                "'EHR_ID' TEXT);"); // 12: EhrId
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'T__USER_INFO'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, T_UserInfo entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public T_UserInfo readEntity(Cursor cursor, int offset) {
        T_UserInfo entity = new T_UserInfo( //
            ...
            cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12) // EhrId
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, T_UserInfo entity, int offset) {
        ...
        entity.setEhrId(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(T_UserInfo entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(T_UserInfo entity) {
        if(entity != null) {
