 ...
 */
package com.gwi.ccly.android.commonlibrary.common.utils.andbase;
...
//        }
    ...
    public static void setViewSize(View view,int widthPixels, int heightPixels){
        ...
        if(params == null){
            LogUtil.e(AbViewUtil.class.getSimpleName(), "setViewSize出错,如果是代码new出来的View，需要设置一个适合的LayoutParams");
            return;
        }
